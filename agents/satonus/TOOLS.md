...
- Role default: Satonus is `codex`-first (`review` + `adversarial-review` + targeted `rescue`) as guardrail.
- Satonus should avoid long `ralph-loop` sessions and focus on hard evidence gates.
